...
class DeliveryVehicle:
    ...
    def deliver(self):
        if self.packages_delivered < self.capacity:
            ...
            return "Entrega realizada con exit"
        else:
            return "El vehiculo ha alcanzado su capacity maxima de entregas"
...
class DeliveryFactory:
    def create_delivery_vehicle(self, vehicle_type):
        if vehicle_type == "motorcycle":
            ...
            raise ValueError("Type de vehiculo de entrega no valid")
...
class DeliveryRequestHandler(BaseHTTPRequestHandler):
    def do_POST(self):
        if self.path == "/delivery":
            ...
            response_data = delivery_handler.handle_delivery_request(request_data)
